package com.linknabor.generator.rest;

import com.alibaba.fastjson.JSON;
import com.linknabor.cloud.msa.common.response.TableResultResponse;
import com.linknabor.generator.service.GeneratorService;
...
public class GeneratorRest {
    ...
    public void code(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        response.reset();
        response.setHeader("Content-Disposition", "attachment; filename=\"bys-msa-code.zip\"");
