...
import com.linknabor.job.service.liquidate.model.xingye.pos.*;
 ...
 */
@RestController
@Service("xingyePosLiquidate")
public class XingyePosLiquidate implements LiquidateService {

    private static Logger LOGGER = LoggerFactory.getLogger(XingyePosLiquidate.class);
    ...
    public List<LiquidateData> pullLiquidateFile(String liquidate_date) {
        List<MchInfo> listMch = liquidateMapper.getLiquidateMch(LiquidateConfigConstant.XingyePos, liquidate_date, LiquidateConfigConstant.XingyePosPayMethod);
    ...
    private List<AcctDetailTrade> getTradeDetail(MchInfo mch_info) throws Exception {
        ...
        while (true) {
            ...
            RespBody<AcctDetailTrade> respBody = resp.getRsp_body();
